  ...
  return (
    <main className="prose container mx-auto flex flex-col items-center">
      ...
      <h4 className="text-center">
        ...
        using computational methods to classify and quantify the emotional tone
      ...
      {loading && <span class="m-5 loading loading-spinner loading-lg"></span>}
      {analysis && (
        <div className="container flex flex-col items-center">
          ...
          <p>If you find any issues, visit </p>
        </div>
      )}
    </main>
  );
